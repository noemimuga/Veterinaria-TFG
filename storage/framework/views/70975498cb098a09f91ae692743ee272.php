    ...
    <div class="card" style="max-width: 800px; margin: 0 auto; animation: fadeInUp 0.6s ease;">
        <div class="card-content">
            <h2 style="font-family: 'Cormorant', serif; font-size: 2.5rem; text-align: center; color: var(--beige-800); margin-bottom: 1rem;">
                Solicitud para adoptar a <?php echo e($animal->nombre); ?>
            ...
            <form action="<?php echo e(route('solicitudes.store', $animal->id)); ?>" method="POST" class="filtros" style="display: flex; flex-direction: column; gap: 1.5rem; background: transparent; border: none; box-shadow: none;">
                <?php echo csrf_field(); ?>

                
                <div style="width: 100%;">
                    <label style="display: block; font-weight: 600; margin-bottom: 0.5rem; color: var(--beige-700);">Nombre Completo</label>
                    <input type="text" name="nombre_completo" value="<?php echo e(Auth::user()->name); ?>" required placeholder="Nombre y apellidos">
                </div>
                ...
                <div style="width: 100%;">
                    <label style="display: block; font-weight: 600; margin-bottom: 0.5rem; color: var(--beige-700);">¿Por qué quieres adoptar a <?php echo e($animal->nombre); ?>?</label>
                ...
                <div style="width: 100%; text-align: center; margin-top: 2rem;">
                    ...
                    <div>
                        <a href="<?php echo e(route('animales.show', $animal->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Veterinaria-TFG\resources\views/solicitudes/create.blade.php ENDPATH**/ ?>