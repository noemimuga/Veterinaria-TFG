...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Refugio de Adopciones'); ?></title>
...
<body>
    <header>
        <nav>
            <a href="<?php echo e(route('home')); ?>" class="logo">Refugio Nubeko</a>

            <ul class="nav-links">
                <li><a href="<?php echo e(route('home')); ?>">Inicio</a></li>
                <li><a href="<?php echo e(route('adopta.index')); ?>">Adoptar</a></li>

                <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->esRefugio()): ?>
                <li><a href="<?php echo e(route('animales.create')); ?>">Publicar Animal</a></li>
                <li><a href="<?php echo e(route('refugio.dashboard')); ?>">Panel Refugio</a></li>
                <?php else: ?>
                <li><a href="<?php echo e(route('contacto.index')); ?>">Contacto</a></li>
                <?php endif; ?>
                ...
                <?php else: ?>
                <li><a href="<?php echo e(route('contacto.index')); ?>">Contacto</a></li>
                <li><a href="<?php echo e(route('login')); ?>" class="btn-primary">Iniciar Sesión</a></li>
                <?php endif; ?>

                
                <li><button class="btn-simple" onclick="toggleDarkMode()">🌙</button></li>
                <li><a href="/lang/es"><img src="<?php echo e(asset('img/flags/espana.png')); ?>" width="24" alt="Español"></a></li>
                <li><a href="/lang/en"><img src="<?php echo e(asset('img/flags/ing.png')); ?>" width="24" alt="English"></a></li>
            </ul>
        </nav>
    </header>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="footer-section">
                <h4>Enlaces</h4>
                <a href="<?php echo e(route('faq')); ?>">Preguntas Frecuentes</a>
                <a href="<?php echo e(route('proceso')); ?>">Proceso de Adopción</a>
                <a href="<?php echo e(route('voluntariado')); ?>">Voluntariado</a>
                <a href="<?php echo e(route('donaciones')); ?>">Donaciones</a>
                <a href="<?php echo e(route('privacidad')); ?>">Política de Privacidad</a>
                <a href="<?php echo e(route('legal')); ?>">Aviso Legal</a>
...
</html><?php /**PATH C:\xampp\htdocs\Veterinaria-TFG\resources\views/layouts/app.blade.php ENDPATH**/ ?>