<?php $__env->startSection('title', 'Contacto y Nosotras - Refugio Nubeko'); ?>
...
<div class="container-contacto">
    ...
    <section class="sobre-nosotros" style="max-width: 1000px; margin: 0 auto; padding: 4rem 2rem;">
        ...
        <div><img src="<?php echo e(asset('img/imagenContacto.jpg')); ?>" alt="Gato y perro" style="width: 100%; max-height: 400px; object-fit: cover; border-radius: 15px; margin-bottom: 2rem;"></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Veterinaria-TFG\resources\views/contacto/index.blade.php ENDPATH**/ ?>